...
tentativas = 0
acertou_palavra1 = False
acertou_palavra2 = False
letras_fora1 = []
letras_fora2 = []

while tentativas < 7 and not (acertou_palavra1 and acertou_palavra2):
    tentativa = input(f"Tentativa {tentativas+1}/7: ").upper()
    ...
    if tentativa not in palavras:
        ...
        continue
    # Preparar visualização para cada palavra secreta
    resultado1 = []
    resultado2 = []
...
if not (acertou_palavra1 and acertou_palavra2):
